...
namespace Launcher
{
    ...
    public class AuthenticationServiceProvider : IDisposable
    {
        ...
        private static readonly string _authenticationTokenEndpoint = "https://www.blackdesertonline.com/launcher/l/api/Login.json";
        private static readonly string _playTokenEndpoint = "https://www.blackdesertonline.com/launcher/l/api/CreatePlayToken.json";
        ...
        private async Task<string> RequestPlayTokenAsync(string authenticationToken)
        {
            ...
            {
                httpRequestMessage.Content = new StringContent($"token={authenticationToken}", Encoding.UTF8, "application/x-www-form-urlencoded");
